...
```typescript
import { RollBackToPreviousVersionResponse } from "pipeshub/models/operations";

let value: RollBackToPreviousVersionResponse = {
  success: true,
  message: "Document rolled back to version 2",
  data: {
...
| `message`                                                                                                                                                                                 | *string*                                                                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                                        | N/A                                                                                                                                                                                       | Document rolled back to version 2                                                                                                                                                         |
