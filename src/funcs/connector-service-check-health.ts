...
import { ConnectorServiceHealthServerList } from "../models/operations/connector-service-health.js";
...
export function connectorServiceCheckHealth(
  ...
  Result<
    operations.ConnectorServiceHealthResponse,
    | PipeshubError
...
> {
  const baseURL = options?.serverURL
    || pathToFunc(ConnectorServiceHealthServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ConnectorServiceHealthResponse$inboundSchema),
    M.fail("4XX"),
    M.fail([500, "5XX"]),
  )(response, req);
  if (!result.ok) {
