 ...
 * </ul>
 */
export function teamsUpdatePermissions(
  client: PipeshubCore,
  request: operations.UpdateTeamUserPermissionsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.UpdateTeamUserPermissionsResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        operations.UpdateTeamUserPermissionsRequest$outboundSchema,
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateTeamUserPermissionsResponse$inboundSchema),
