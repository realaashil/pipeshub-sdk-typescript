...
import { IndexingServiceHealthServerList } from "../models/operations/indexing-service-health.js";
...
export function indexingServiceHealth(
  ...
  Result<
    operations.IndexingServiceHealthResponse,
    | PipeshubError
...
> {
  const baseURL = options?.serverURL
    || pathToFunc(IndexingServiceHealthServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.IndexingServiceHealthResponse$inboundSchema),
    M.fail("4XX"),
    M.fail([500, "5XX"]),
  )(response, req);
  if (!result.ok) {
