...
export function teamsRemoveUsers(
  ...
  Result<
    operations.RemoveUsersFromTeamResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.RemoveUsersFromTeamRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.RemoveUsersFromTeamResponse$inboundSchema),
