...
import { GmailWebhookServerList } from "../models/operations/gmail-webhook.js";
 ...
 */
export function webhooksPostGmail(
  client: PipeshubCore,
...
> {
  const baseURL = options?.serverURL
    || pathToFunc(GmailWebhookServerList[0], { charEncoding: "percent" })();
