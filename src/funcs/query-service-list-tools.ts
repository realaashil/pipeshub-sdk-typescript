...
import { QueryListToolsServerList } from "../models/operations/query-list-tools.js";
...
export function queryServiceListTools(
  ...
  Result<
    Array<operations.QueryListToolsResponse>,
    | PipeshubError
...
> {
  const baseURL = options?.serverURL
    || pathToFunc(QueryListToolsServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, z.array(operations.QueryListToolsResponse$inboundSchema)),
    M.fail([401, "4XX"]),
    M.fail([500, "5XX"]),
  )(response, req);
  if (!result.ok) {
