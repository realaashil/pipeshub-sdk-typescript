...
export function usersCheckIsAdmin(
  ...
  Result<
    operations.CheckUserIsAdminResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.CheckUserIsAdminRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.CheckUserIsAdminResponse$inboundSchema),
