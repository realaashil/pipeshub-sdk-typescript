...
export function metricsCollectionSetPushInterval(
  ...
  Result<
    operations.SetMetricsPushIntervalResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.SetMetricsPushIntervalRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SetMetricsPushIntervalResponse$inboundSchema),
