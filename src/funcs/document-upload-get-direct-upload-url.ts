 ...
 */
export function documentUploadGetDirectUploadUrl(
  client: PipeshubCore,
  request: operations.GetDirectUploadUrlRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetDirectUploadUrlResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.GetDirectUploadUrlRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetDirectUploadUrlResponse$inboundSchema),
