 ...
 */
export function metricsCollectionSetServerUrl(
  client: PipeshubCore,
  request: operations.SetMetricsServerUrlRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.SetMetricsServerUrlResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(operations.SetMetricsServerUrlRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SetMetricsServerUrlResponse$inboundSchema),
