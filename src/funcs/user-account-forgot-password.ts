...
export function userAccountForgotPassword(
  ...
  Result<
    operations.ForgotPasswordResponse,
    | PipeshubError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.ForgotPasswordRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ForgotPasswordResponse$inboundSchema),
    M.fail([400, 429, "4XX"]),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
