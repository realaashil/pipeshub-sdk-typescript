...
export function userAccountGenerateLoginOtp(
  ...
  Result<
    operations.GenerateLoginOtpResponse,
    | errors.AuthError
    | PipeshubError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.OtpGenerateRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GenerateLoginOtpResponse$inboundSchema),
