...
import { uploadFiles } from "../funcs/upload-files.js";
import { uploadGetLimits } from "../funcs/upload-get-limits.js";
import { uploadToFolder } from "../funcs/upload-to-folder.js";
...
export class Upload extends ClientSDK {
  ...
  async files(
    ...
    return unwrapAsync(uploadFiles(
      this,
      request,
      options,
    ));
  ...
  async toFolder(
    ...
    return unwrapAsync(uploadToFolder(
      this,
      request,
      options,
    ));
  ...
  async getLimits(
    ...
    return unwrapAsync(uploadGetLimits(
      this,
      options,
    ));
  }
