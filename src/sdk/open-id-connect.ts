...
import { openIDConnectGetConfiguration } from "../funcs/open-id-connect-get-configuration.js";
import { openIDConnectGetUserInfo } from "../funcs/open-id-connect-get-user-info.js";
...
export class OpenIDConnect extends ClientSDK {
  ...
  async getConfiguration(
    ...
    return unwrapAsync(openIDConnectGetConfiguration(
      this,
      options,
    ));
  }
