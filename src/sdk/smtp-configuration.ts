...
import { smtpConfigurationCreateOrUpdate } from "../funcs/smtp-configuration-create-or-update.js";
import { smtpConfigurationGet } from "../funcs/smtp-configuration-get.js";
...
export class SmtpConfiguration extends ClientSDK {
  ...
  async createOrUpdate(
    ...
    return unwrapAsync(smtpConfigurationCreateOrUpdate(
      this,
      request,
      options,
    ));
  ...
  async get(
    ...
    return unwrapAsync(smtpConfigurationGet(
      this,
      options,
    ));
  }
