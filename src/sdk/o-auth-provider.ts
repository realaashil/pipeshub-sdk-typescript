...
import { oAuthProviderOauthAuthorizeConsent } from "../funcs/o-auth-provider-oauth-authorize-consent.js";
import { oAuthProviderOauthAuthorize } from "../funcs/o-auth-provider-oauth-authorize.js";
...
export class OAuthProvider extends ClientSDK {
  ...
  async oauthAuthorize(
    ...
    return unwrapAsync(oAuthProviderOauthAuthorize(
      this,
      request,
      options,
    ));
